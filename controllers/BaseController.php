...
namespace arteam\controllers;

use arteam\behaviors\AccessFilter;
use Yii;
...
abstract class BaseController extends Controller
{
    ...
    public function init()
    {
        ...
        if (!Yii::$app->errorHandler->exception && Yii::$app->arteam->isMultilingual) {
            ...
            if (Yii::$app->getRequest()->post('language', NULL)) {
                $language = Yii::$app->arteam->getSourceLanguageShortcode(Yii::$app->getRequest()->post('language'));
            ...
            if ($language = Yii::$app->getRequest()->get('language', NULL)) {
                ...
                $language = Yii::$app->arteam->getSourceLanguageShortcode($language);
