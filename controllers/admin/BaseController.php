...
namespace arteam\controllers\admin;
...
abstract class BaseController extends \arteam\controllers\BaseController
{
    /**
     * @var ActiveRecord
     */
     ...
     * @var string
     */
    public $layout = '@vendor/arteam/at-team-core/views/layouts/admin/main.php';
    ...
    {
        /* @var $model \arteam\db\ActiveRecord */
        $model = new $this->modelClass;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('crudMessage', Yii::t('arteam', 'Your item has been created.'));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) AND $model->save()) {
            Yii::$app->session->setFlash('crudMessage', Yii::t('arteam', 'Your item has been updated.'));
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('crudMessage', Yii::t('arteam', 'Your item has been deleted.'));
