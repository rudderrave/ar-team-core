...
class GridBulkActions extends Widget
{
    ...
    public function init()
    {
        ...
        $this->promptText = $this->promptText ? $this->promptText : Yii::t('arteam', '--- With selected ---');
    ...
    protected function setDefaultOptions()
    {
        if (!$this->actions) {
            $this->actions = [
                Url::to(['bulk-activate']) => Yii::t('arteam', 'Activate'),
                Url::to(['bulk-deactivate']) => Yii::t('arteam', 'Deactivate'),
                Url::to(['bulk-delete']) => Yii::t('arteam', 'Delete'),
            ];
        }
