...
class AccessFilter extends ActionFilter
{
    ...
    public function beforeAction($action)
    {
        ...
        if (User::canRoute($route)) {
            ...
            if ($modelClass && ArteamHelper::isImplemented($modelClass, OwnerAccess::CLASSNAME) && !User::hasPermission($modelClass::getFullAccessPermission()) && $modelId) {
