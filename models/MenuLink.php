...
use arteam\behaviors\MultilingualBehavior;
use Yii;
use yii\behaviors\BlameableBehavior;
use yii\behaviors\SluggableBehavior;
use yii\behaviors\TimestampBehavior;
use arteam\db\ActiveRecord;
...
class MenuLink extends ActiveRecord implements OwnerAccess
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'match', 'pattern' => '/^[a-z0-9_-]+$/', 'message' => Yii::t('arteam', 'Link ID can only contain lowercase alphanumeric characters, underscores and dashes.')],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('arteam', 'ID'),
            'menu_id' => Yii::t('arteam', 'Menu'),
            'link' => Yii::t('arteam', 'Link'),
            'label' => Yii::t('arteam', 'Label'),
            'parent_id' => Yii::t('arteam', 'Parent Link'),
            'alwaysVisible' => Yii::t('arteam', 'Always Visible'),
            'image' => Yii::t('arteam', 'Icon'),
            'order' => Yii::t('arteam', 'Order'),
            'created_by' => Yii::t('arteam', 'Created By'),
            'updated_by' => Yii::t('arteam', 'Updated By'),
    ...
    public function getSiblings()
    {
        ...
        return ArrayHelper::merge([NULL => Yii::t('arteam', 'No Parent')], $list);
    }
