...
class Menu extends ActiveRecord implements OwnerAccess
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'match', 'pattern' => '/^[a-z0-9_-]+$/', 'message' => Yii::t('arteam', 'Menu ID can only contain lowercase alphanumeric characters, underscores and dashes.')],
        ];
    }
