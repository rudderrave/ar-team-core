...
class UserVisitLog extends ActiveRecord
{
    ...
    public static function newVisitor($userId)
    {
        ...
        $model->token = uniqid();
        $model->ip = ArteamHelper::getRealIp();
    ...
    {
        return Yii::$app->arteam->user_visit_log_table;
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('arteam', 'ID'),
            'token' => Yii::t('arteam', 'Token'),
            'ip' => Yii::t('arteam', 'IP'),
            'language' => Yii::t('arteam', 'Language'),
            'browser' => Yii::t('arteam', 'Browser'),
            'os' => Yii::t('arteam', 'OS'),
            'user_agent' => Yii::t('arteam', 'User agent'),
            'user_id' => Yii::t('arteam', 'User'),
            'visit_time' => Yii::t('arteam', 'Visit Time'),
        ];
    }
