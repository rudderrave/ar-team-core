...
class MultilingualUrlManager extends UrlManager
{
    ...
    public function createUrl($params)
    {
        ...
        if (Yii::$app->arteam->isMultilingual && !empty($this->multilingualRules)) {
            $languages = array_keys(Yii::$app->arteam->displayLanguages);
            ...
            if (!isset($params['language'])) {
                ...
                $params['language'] = Yii::$app->arteam->getDisplayLanguageShortcode(Yii::$app->language);
            }
        }
    ...
    {
        $rules = $this->rules;
        $prefix = Yii::$app->arteam->isMultilingual ? $this->languagePattern . '/' : '';
